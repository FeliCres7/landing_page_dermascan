    ...
    return (
        <div className="App">
            ...
            <div>
                ...
                <h3>En solo tres pasos simples, obtené un análisis completo de riesgo y recomendaciones personalizadas para el cuidado de tu piel.</h3>

                <div><p>1</p><h2>Fotografiá tus Lunares</h2><p>Usa la cámara de tu smartphone para capturar imágenes claras de lunares o manchas sospechosas.</p></div>
                <div><p>2</p><h2>Análisis con IA</h2><p>Nuestra inteligencia artificial analiza la imagen y evalúa patrones de riesgo en segundos.</p></div>
                <div><p>3</p><h2>Recibe Resultados</h2><p>Obtén un reporte detallado con nivel de riesgo y recomendaciones médicas específicas.</p></div>
            </div>

            <div><div>
                <h1>¿Por Qué es Tan Importante la Detección Temprana?</h1>
